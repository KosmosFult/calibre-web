...
class DSPyFilter:
    def __init__(self, narrtiverag):
        ...
        Args:
            narrtiverag : An object that provides the global configuration and the LLM model required for inference.
        """
        self.global_config = narrtiverag.global_config
        self.llm_infer_fn = narrtiverag.llm_model.infer
        self.model_name = narrtiverag.global_config.llm_name
        dspy_file_path = narrtiverag.global_config.rerank_dspy_file_path
