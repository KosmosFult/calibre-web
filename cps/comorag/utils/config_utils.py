...
class BaseConfig:
    ...
    llm_provider: Optional[Literal["openai_compat", "google_genai"]] = field(
        default=None,
        metadata={"help": "LLM provider backend. If None, infer from model/base_url."}
    )
    ...
    embedding_provider: Optional[Literal["openai_compat", "google_genai"]] = field(
        default=None,
        metadata={"help": "Embedding provider backend. If None, infer from model/base_url."}
    )
